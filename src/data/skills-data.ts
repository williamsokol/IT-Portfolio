...
export const skillsData: Record<string, SkillCategory> = {
  ...
  security: {
    ...
    skills: [
      { name: 'CompTIA Tech+', detail: 'Certified in fundamental IT support, hardware troubleshooting, and technical problem-solving.' },
      { name: 'Google Cybersecurity', detail: 'Comprehensive training in threat detection, security operations, and incident response procedures.' },
      { name: 'Azure Security', detail: 'Cloud security best practices, identity management, and Azure security center configuration.' },
      { name: 'Access Control', detail: 'Implementation of role-based access control, authentication systems, and authorization frameworks.' }
    ]
  },
  operations: {
    title: "Operations",
